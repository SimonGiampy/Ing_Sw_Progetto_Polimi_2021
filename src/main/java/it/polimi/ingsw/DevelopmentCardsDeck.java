...
public class DevelopmentCardsDeck {
	 ...
	 */
	protected boolean isCardBuyable(int level, Colors color, ArrayList<Resources> playerResources, CardProductionsManagement playersCard) {
	 ...
	 */
	protected boolean canBuyDevCard(ArrayList<Resources> playersResources, CardProductionsManagement manager) {
		for (int i = 0; i < 3; i++) {
